...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    public void onButtonClickDownloadImages(View v){
        ...
        String fileName = "IMP" + System.currentTimeMillis() + ".JPG";

        try {
            File file = new File(externalStorageDirStr, fileName);
            FileOutputStream fos = new FileOutputStream(file);
            _impressionistView.getBitmap().compress(Bitmap.CompressFormat.JPEG, 100, fos);
            ...
            Log.v("DOWNLOAD IMAGES", "File Not Found Exception");
        }
    }
